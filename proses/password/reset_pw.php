...
if($email==$email_db){
    ...
    $emailTo = $email; //email kamu atau email penerima link reset


    $code = uniqid(true); //Untuk kode atau parameter acak

    $query = mysqli_query($koneksi, "INSERT INTO reset_pw (id_user, email, code) VALUES ('$id_user','$emailTo','$code')");
    ...
    try {
        ...
        $mail->Username = "rambocool888@gmail.com";     // SMTP username

        $mail->Password = 'utahazwznxjwdmdd';                         // SMTP password
        ...
        $mail->setFrom("rambocool888@gmail.com", "Esthree"); //email pengirim
        ...
        $url = "https://" . $_SERVER["HTTP_HOST"] .dirname($_SERVER["PHP_SELF"]). "/reset.php?reset_pass=$code"; //sesuaikan berdasarkan link server dan nama file
 ...
 <body style='width:100%;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0'> 
  <div class='es-wrapper-color' style='background-color:#FAFAFA'> 
   ...
   <table class='es-wrapper' width='100%' cellspacing='0' cellpadding='0' style='mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;padding:0;Margin:0;width:100%;height:100%;background-repeat:repeat;background-position:center top'> 
    ...
    // exit();
    header("location: lupa_pw.php?pesan=sukses", true, 301);


}else{
    header("location: lupa_pw.php?pesan=kosong", true, 301);
