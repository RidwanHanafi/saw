	...
	<div class="limiter">
		<div class="container-login100 bg">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
				<form class="login100-form validate-form" method="POST" action="reset_pw.php">
					...
					<div  class="txt2" style="color:grey">Kembali ke<a href="<?php echo base_url() ?>" class="txt2 hov1">
							Login?
						</a></div>
