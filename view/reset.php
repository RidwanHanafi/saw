...
require '../base_url.php'; 
  ...
  $query = mysqli_query($koneksi, "SELECT email FROM `reset_pw` WHERE code = '$code' ");
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
				<form class="login100-form validate-form" method="POST" action="lupa_pw.php">
  ...
  .bg{
    ...
    background-size: cover;
					...
					<div  class="container-login100-form-btn m-t-20">
						<button type="submit" name="reset_pass" class="login100-form-btn">
							Kirim
						</button>
					</div>
				</form>
